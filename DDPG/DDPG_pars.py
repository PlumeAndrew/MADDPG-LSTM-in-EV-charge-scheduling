...
def parse_args():
    ...
    parser.add_argument("--agents", type=int, default=1, help="num of agents")
    ...
    parser.add_argument("--fc_2", type=int, default=64, help="dims of the first full connected layers")
